...
const index = () => {
  return (
    <div  className='w-full lg:h-48 flex flex-col lg:flex-row overflow-hidden px-16'>
      ...
      <motion.img initial={{y:+100}}whileHover={{scale:1.2,transition:{duration:0.25}}}whileInView={{y:1,transition:{duration:1}}}className='h-full w-1/5 mix-blend-darken 'src={img1}height={100} width={100}/>
