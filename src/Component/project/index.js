...
import bulkemail from "./img/bulkemail.jpg";
      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
        ...
        <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <motion.div
            ...
            <a href="https://linktree-psgpraveen.vercel.app"
            ...
            <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              <a href="https://linktree-psgpraveen.vercel.app"
                target="_blank" rel="noreferrer">linktree</a>
            </h3>
            <ul className="flex justify-center mt-4 space-x-4">
              <li>
                <a
                  href="https://github.com/psgpraveen/Linktree"
                  target="_blank" rel="noreferrer"
              ...
              <li>
                <a
                  href="https://linktree-psgpraveen.vercel.app/"
                  target="_blank" rel="noreferrer"
          ...
          <motion.div
            ...
            whileInView={{ x: 1, transition: { duration: 1 } }}
            className="text-center text-gray-500 dark:text-gray-400">
            <a href="https://bulkemails.vercel.app"
              target="_blank" rel="noreferrer">
              <img
                className="mx-auto mb-4 w-36 h-36 rounded-full"
                src={bulkemail}
            ...
            <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              <a href="https://bulkemails.vercel.app"
                target="_blank" rel="noreferrer">BulkEmail-Sender</a>
            </h3>
            <ul className="flex justify-center mt-4 space-x-4">
              {/* <li>
                <a
              ...
              <li>
                <a
                  href="https://bulkemails.vercel.app"
                  target="_blank" rel="noreferrer"
                  className="text-[#ea4c89] hover:text-gray-900 dark:hover:text-white">
                  <svg
                    className="w-6 h-6"
          ...
          <motion.div
            ...
            <ul className="flex justify-center mt-4 space-x-4">
              ...
              <li>
                <a
                  href="https://psgpraveen.github.io/E-commerce-website-/"
                  className="text-[#ea4c89] hover:text-gray-900 dark:hover:text-white">
                  <svg
                    className="w-6 h-6"
                    fill="currentColor"
